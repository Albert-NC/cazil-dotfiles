...
alias cpu-eco='bash $HOME/.local/bin/perfil-energia powersave'
alias cpu-max='bash $HOME/.local/bin/perfil-energia performance'
alias cpu-auto='bash $HOME/.local/bin/perfil-energia reset'
